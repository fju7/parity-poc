...
## 1. The scope statement — rendered under the title from the record (reordered 2026-09-15 evening on the operator's read: evidence first; the GMC sentence no longer says anything "appears here about the GMC", because after 721f53f7 nothing does)

It is rendered from `scope_statement` in the publication record (source file `backend/data/verify/scope/mmr-vaccine-autism.md`). Current text:
...
## 2. Thirteen IDENTITY_ONLY claims, weakest first (of 68 — 29 of them relabelled from figure-bound today) — each carries *"Source identified; not checked against it"*
