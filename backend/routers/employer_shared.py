...
# ---------------------------------------------------------------------------
# Rate limiter — disabled for pre-production. Will re-enable with proper
# per-user (not per-IP) limits before GA launch.
# ---------------------------------------------------------------------------

def check_rate_limit(request: Request, max_requests: int = 0, window_seconds: int = 3600):
    """No-op — rate limiting disabled for pre-production."""
    pass
