...
3. **Shaw & Nave, "11.7 percentage points"** (c86). Secondary sources split between percentage points and a relative percentage. SSRN's delivery endpoint 404s to a machine. The operator has the PDF and can settle it in one lookup; until then the page's wording is unchanged and the ambiguity is on the record here.
