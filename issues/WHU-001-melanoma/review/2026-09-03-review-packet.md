...
**Rests on:**
  - [S020] "title":"Overall Survival (OS) for All Participants"
  - [S026] "title":"Overall Survival (OS)"
...
**The step we take.** The site publishes at /en/ under a strapline that reads as translated, and a search of the open web excluding its own domain on 3 September 2026 returned no third party citing it — no publication, aggregator or outlet. So we can vouch for the argument but not for the outlet, and the sentence says which. The argument itself is checkable without it: the stage widening is in the Phase 3 release, and Pharmacy Times, an outlet with standing, makes the opposing case in its own words.
...
| S004 | full_text_held | Five-year results — Journal of Clinical Oncology, 1 June 2026 |
...
| S014 | blocked | KEYNOTE-942 five-year update — ASCO 2026 abstract 9500. J Clin Oncol 44 (suppl 16; abstr 9500) |  <-- WE COULD NOT READ THIS IN FULL
...
| S017 | blocked | OncLive — Intismeran Autogene Plus Pembrolizumab Meets RFS, DMFS End Points in Resected Melanom |  <-- WE COULD NOT READ THIS IN FULL
...
| S023 | not_opened | Spruance, Reid, Grace, Samore — Hazard Ratio in Clinical Trials. Antimicrob Agents Chemother, 2 |  <-- WE COULD NOT READ THIS IN FULL
...
<header>
  <div class="kicker-row">
    ...
    <span class="meta">Published 26 August 2026 &middot; Updated <a href="#updates">2 September 2026</a> &middot; event dated 19 August 2026</span>
  </div>
...
<section>
  ...
  <div class="note">
    ...
    <p>Every outlet whose article we hold attributed those figures correctly to KEYNOTE-942 &mdash; The ASCO Post, Dermatology Times, Practical Dermatology, KOL Pulse and MLQ News &mdash; and several said plainly that no Phase 3 efficacy numbers had been released. <a href="https://mlq.ai/news/moderna-mercks-personalized-melanoma-therapy-meets-two-phase-3-endpoints/">MLQ News</a>: <q>The companies have not disclosed hazard ratios, confidence intervals, p-values, median follow-up or event counts for the Phase 3 trial.</q> <a href="https://practicaldermatology.com/news/intismeran-plus-pembrolizumab-meets-dual-phase-3-melanoma-endpoints/2488176/">Practical Dermatology</a>: <q>The companies did not disclose hazard ratios, absolute event rates, P values, or other phase 3 efficacy estimates in the topline announcement.</q> And <a href="https://www.dermatologytimes.com/view/personalized-mrna-based-melanoma-vaccine-meets-primary-endpoints-in-landmark-phase-3-trial">Dermatology Times</a>: <q>Detailed phase 3 efficacy metrics (e.g., HRs) were not disclosed; OS and other secondary endpoints remain immature</q> (An earlier version of this sentence also named OncLive and FierceBiotech. We hold neither article, so neither is named here.)</p>
...
<section>
  <div class="section-head">
    ...
    <p>Coverage has been merging them. Different sizes, different patients, different rigour — and only one has published numbers.</p>
  </div>
  ...
  <p>The Phase 3 substantially reduces that problem. It is double-blind and placebo-controlled, so nobody assessing a recurrence knows which treatment produced it. <strong>It is the more trustworthy trial by a wide margin</strong> — seven times larger, and blinded against the assessment bias the earlier one carried. Which is precisely why it is frustrating that its numbers are the ones we do not have.</p>
  ...
  <div class="grid2">
    ...
    <div class="unknown">
      ...
      <ul>
        ...
        <li><strong>Whether anyone lives longer, and by how much.</strong> The only survival figure in the programme is descriptive and rests on fourteen deaths; its interval, 0.165 to 1.345, is too wide to separate a large benefit from a small harm. The question is open, not answered either way.</li>
...
<footer id="updates">
  ...
  <p><strong>The third figure has not come back.</strong> We also removed a
  &ldquo;five-year topline of 20 January 2026&rdquo; reporting a one-sided
  nominal p&nbsp;=&nbsp;0.0075. That document is still in nothing we hold and in
  no source list on this page, and nothing found since has changed that. It
  stays out until somebody produces it.</p>
  ...
  is an open question rather than a settled no, and the piece now says so. We had
  scored data support 1 against the rubric&rsquo;s anchor of &ldquo;no data
  cited,&rdquo; when a directional result was cited and what is absent is magnitude.
  ...
  adjuvant PD-1 trial has shown a survival benefit, which is too absolute — no
  randomised trial against placebo has done so as a prespecified endpoint, but
  indirect comparisons have suggested a signal. We had credited too few of the
