    ...
    <div style={{ minHeight: "100vh", background: "#0a0f1e", color: "white" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={sectionStyle}>
          ...
          <a href="mailto:admin@civicscale.ai?subject=Parity%20Provider%20Support%20Request" style={{ color: "#5eead4", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>admin@civicscale.ai</a>
        </div>
