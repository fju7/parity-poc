      ...
      <div className="report-page" style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px 60px" }}>
        ...
        <Section title="Claims Analysis">
          {claims.available ? (
            ...
            <Placeholder text="Not yet analyzed." cta="Upload claims data to complete this section" ctaLink="/broker/dashboard" />
          )}
        </Section>
        ...
        <Section title="Plan Design Score">
          {scorecard.available ? (
            ...
            <Placeholder text="Not yet graded." cta="Complete plan scorecard to add this section" ctaLink="/broker/dashboard" />
          )}
        </Section>
