...
import { applyHostMeta } from './lib/pageMeta'
...
// ── SEO: per-host meta tags ──
// The authoritative copy of these tags is stamped into static HTML at build
// time by scripts/generate-host-html.mjs, because crawlers and link-preview
// bots never run this file. This runtime pass keeps the DOM in sync during
// client-side navigation and in local dev, where no build step has run.
applyHostMeta(window.location.hostname);
